...
def send_sms_to_patient_one_day_to_appointment():
    ...
    for appointment in all_reserve_appointment:
        ...
        if delta == 0:
            ...
            text=f'{patient_name} aziz nobat pezeshk shoma az doctor {doctor_name}farda da tarikh {str(date_of_appointment)}  dar saat {time_of_appointment} gharar darad lotfan 15 daghighe ghabl dar matab hozor dashte bashid'
            # sms with kave negar
